export const projectsData = [
  ...
  {
    title: "Axiom",
    description: "3D graphics and game dev testing environment built with Three.js, showcasing shaders, particle systems, and physics simulations for creative experimentation.",
    technologies: [
      "Next.js",
      "Three.js",
      "TypeScript",
  ...
  {
    title: "POE2 Tools",
    description: "Next.js toolkit for Path of Exile 2 featuring skill tree visualization, build planning, and DPS calculations, demonstrating dynamic UI and complex integrations.",
    technologies: [
      "Next.js 15",
      "TypeScript",
      "Tailwind CSS",
  ...
  {
    title: "SteamShare",
    description: "Steam screenshot management platform with integrated gallery organization and canvas editing, real-time data handling and interactive media processing.",
    technologies: [
      "React 18",
      "TypeScript",
      "Steam Web API",
  ...
  },
  {
    ...
    description: "Digital platform for NZ motorcycle tours using Vue and Supabase, server-side caching, dynamic tour management, and interactive route visualization.",
    technologies: [
      "Vue.js",
      "Supabase",
      "Redis",
  ...
  },
  {
    ...
    description: "A comprehensive Next.js template featuring UI components, 3D capabilities, and example implementations, serving as a robust foundation for modern web apps.",
    technologies: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
  ...
  {
    title: "Golf2Go",
    description: "Modern business website for a portable miniature golf company, rebuilt with Next.js for improved performance and a refined user experience.",
    technologies: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
  ...
  {
    title: "Checkpoint",
    description: "GitHub analytics dashboard built with Next.js featuring interactive contribution visualizations, language distribution analysis, and detailed activity metrics.",
    technologies: [
      "Next.js 15",
      "TypeScript",
      "GitHub GraphQL API",
