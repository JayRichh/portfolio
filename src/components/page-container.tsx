...
export const PageContainer: React.FC<PageContainerProps> = ({
  ...
  return (
    <div className={`relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-background via-background/95 to-background/90 text-foreground pt-16 ${className}`}>
