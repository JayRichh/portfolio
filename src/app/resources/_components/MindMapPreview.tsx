...
export function MindMapPreview() {
  ...
  useEffect(() => {
    ...
    const simulation = d3.forceSimulation(previewNodes)
    ...
    nodes.filter(d => (d.importance || 0) > 4)
      .append("text")
      .attr("dy", 20)
  ...
  return (
    <div ref={containerRef} className="w-full h-full bg-gradient-to-br from-background via-background/80 to-background">
