...
export function HeroSection({ onScrollClick }: HeroSectionProps) {
  return (
    <div className="relative h-screen flex items-center justify-center w-full bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-900">
      ...
      >
        <motion.span
          className="text-xl sm:text-2xl md:text-3xl text-gray-600 dark:text-white/90 mb-6 md:mb-8 block font-medium tracking-wide"
        ...
        <motion.h1
          className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold mb-8 md:mb-10 bg-clip-text text-transparent bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 dark:from-white dark:via-white/90 dark:to-white/80 tracking-tight"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.p
          className="text-lg sm:text-xl md:text-3xl text-gray-600 dark:text-white/85 mb-12 md:mb-16 max-w-4xl mx-auto leading-relaxed tracking-wide"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <span className="text-base sm:text-lg md:text-xl text-gray-500 dark:text-gray-400 tracking-wide">
            Scroll to explore
          </span>
