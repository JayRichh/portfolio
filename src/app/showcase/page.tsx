...
export default function ShowcasePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-b from-background via-background/95 to-background">
      ...
      {/* Hero Section */}
      <div className="relative h-[50vh] flex items-center justify-center w-full">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div className="w-full">
        {/* SteamShare Section */}
        <div className="w-full bg-[#1b2838]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
                ...
                <div className="lg:col-span-5 space-y-6 sm:space-y-8 md:space-y-10 order-1 lg:order-2">
                  <motion.h2
                    ...
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-[#66c0f4]"
                  >
                    SteamShare
                  </motion.h2>
                  <motion.div
                  ...
                  >
                    <p className="text-base sm:text-lg md:text-2xl text-zinc-200 leading-relaxed">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
                <div className="lg:col-span-5 space-y-6 sm:space-y-8 md:space-y-10">
                  <motion.h2
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6 }}
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-primary"
                  >
                    CSS Battle
                  </motion.h2>
                  <motion.div
        ...
        <div className="w-full bg-gradient-to-b from-emerald-950 to-background">
          <div className="mx-auto max-w-[90rem] min-h-screen py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 relative">
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
                <div className="lg:col-span-5 space-y-6 sm:space-y-8 md:space-y-10">
                  <motion.h2
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6 }}
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-[#4CAF50]"
                  >
                    Encompass Tours
                  </motion.h2>
                  <motion.div
        ...
        {/* PomoDev Section */}
        <div className="w-full bg-gradient-to-b from-rose-950 to-background">
          <div className="mx-auto max-w-[90rem] min-h-screen py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 relative">
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
                ...
                <div className="lg:col-span-5 space-y-6 sm:space-y-8 md:space-y-10 order-1 lg:order-2">
                  <motion.h2
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6 }}
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-[#FF6B6B]"
                  >
                    PomoDev
                  </motion.h2>
                  <motion.div
                    ...
                    className="space-y-4 md:space-y-6"
                  >
                    <p className="text-base sm:text-lg md:text-2xl text-rose-100 leading-relaxed">
        ...
        {/* Work Waka Section */}
        <div className="w-full bg-gradient-to-b from-zinc-900 to-background">
          <div className="mx-auto max-w-[90rem] min-h-screen py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 relative">
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
                ...
                <div className="lg:col-span-5 space-y-6 sm:space-y-8 md:space-y-10 order-1 lg:order-2">
                  <motion.h2
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6 }}
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-zinc-200"
                  >
                    The Work Waka
                  </motion.h2>
                  <motion.div
                    ...
                    className="space-y-4 md:space-y-6"
                  >
                    <p className="text-base sm:text-lg md:text-2xl text-zinc-300 leading-relaxed">
