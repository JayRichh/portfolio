...
export const CATEGORIES = {
  language: {
    name: "Languages",
    color: "rgba(99, 102, 241, 0.85)", // Softer indigo
    glow: "rgba(99, 102, 241, 0.2)",
  },
  framework: {
    name: "Frameworks",
    color: "rgba(16, 185, 129, 0.85)", // Softer emerald
    glow: "rgba(16, 185, 129, 0.2)",
  },
  tool: {
    name: "Tools",
    color: "rgba(239, 68, 68, 0.85)", // Softer red
    glow: "rgba(239, 68, 68, 0.2)",
  },
  concept: {
    name: "Concepts",
    color: "rgba(59, 130, 246, 0.85)", // Softer blue
    glow: "rgba(59, 130, 246, 0.2)",
  },
  project: {
    name: "Projects",
    color: "rgba(168, 85, 247, 0.85)", // Softer purple
...
export function processWords(
  ...
  // Randomly select words up to a limit
  const wordCount = Math.floor(35 + Math.random() * 10); // Between 35 and 45 words
